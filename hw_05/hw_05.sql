...
SELECT b1.game_id, b1.team_id, b1.win, (CASE WHEN SUM(b2.inning) > 0 THEN (SUM(b2.Walk) + SUM(b2.Hit)) / SUM(b2.inning) ELSE 0 END) AS WHIP, b2.inning, b2.local_date AS date2, b1.local_date AS date1
...
SELECT rh.game_id, rh.team_id AS Home, ra.team_id AS Away, rh.win AS HomeTeamWins, (rh.WHIP - ra.WHIP) AS Difference_WHIP
...
SELECT rh.game_id, rh.HomeTeamWins, rh.Home, rh.Away, rh.Difference_WHIP, rh.Difference_BABIP, rh.Difference_OBP, rh.Difference_RC, rh.Difference_AB_HR
    , rh.Difference_BB_K
